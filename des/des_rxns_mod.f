...
! Amount of solid phase enthalpy change due to phase change/chemical reaction
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: DES_HOR_s

! Amount produced of TFM solid phase species
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_R_sp_TFM
! Amount consumed of TFM solid  phase species
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_R_sc_TFM
! Net production (+) or consumption (-)  of TFM solid phase species
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: DES_SUM_R_s_TFM
