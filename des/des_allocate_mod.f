...
! Rate of solids phase consumption for each species
		 ...
		 Allocate( DES_HOR_s( DIMENSION_3 ) )

         Allocate( DES_R_sp_TFM( DIMENSION_3, DIMENSION_N_s ) )
         Allocate( DES_R_sc_TFM( DIMENSION_3, DIMENSION_N_s ) )
         Allocate( DES_SUM_R_s_TFM( DIMENSION_3 ) )
