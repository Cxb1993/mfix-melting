...
! Maximum particles permitted in the system at once
	  ...
	  DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: PART_VOL_INTERSEC
	  INTEGER, DIMENSION(:,:), ALLOCATABLE :: PART_CELLS
      DOUBLE PRECISION, DIMENSION(:), ALLOCATABLE :: TOT_VOL_INTERSEC
